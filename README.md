...
<table>
  <tr>
    <td width="58%" valign="top">
      ...
      <p>
        从一根引脚的电平到一串 token 的生成，感兴趣的始终是同一件事：
        系统为什么是现在这个样子。
      </p>
      <ul>
        <li>不满足于「能跑」：要知道为什么跑、边界在哪、什么条件下会挂。</li>
        <li>大部分惊艳都会过时，简单和正确不会。</li>
        <li>对「恰好能用」不放心，对「知道为什么能用」才放心。</li>
        <li>每天的修行：读一点源码，磨一件工具，验证一个猜想。</li>
      </ul>
      <p>
